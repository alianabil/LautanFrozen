    ...
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ...
          : "bg-gradient-to-r from-blue-900/80 to-cyan-800/80 backdrop-blur-md py-2 text-white"
      }`}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center">
            ...
            >
              ...
              <span className={`text-2xl font-bold ${isScrolled ? "text-sky-700" : "text-cyan-300"} ml-0.5`}>
                Frozen
              </span>
            </motion.div>
          </Link>
              ...
              <div className="relative group">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  ...
                  >
                    ...
                    <span className="hidden sm:inline-block text-sm">{user.name?.split(" ")[0]}</span>
                    <ChevronDown className="h-4 w-4" />
                  </Button>
                </motion.div>
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg overflow-hidden z-50 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-200 transform origin-top-right scale-95 group-hover:scale-100">
                  <div className="py-2">
            ...
            >
              <div className="flex gap-2">
                <Input
                  ...
                  className="w-full bg-white/90 backdrop-blur-sm border-blue-200 focus-visible:ring-blue-400"
                  autoFocus
                />
